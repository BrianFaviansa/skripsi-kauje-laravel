...
export default function (data) {
    ...
    group("Forums - Get All", function () {
        const res = http.get(`${BASE_URL}/forums?page=1&per_page=10`, {
            headers: authHeaders,
        });
    ...
    if (createdForumId) {
        ...
        group("Forums - Update", function () {
            ...
            const res = http.put(
                `${BASE_URL}/forums/${createdForumId}`,
                payload,
                {
                    headers: authHeaders,
                },
...
export function teardown(data) {
    console.log("Forum Module Load Test Completed");
}
